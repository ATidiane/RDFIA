...
def main(params):
    ...
    lr_sched = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[150, 200], gamma=0.1)
    ...
    pd_acc_loss_avg.to_csv(
        'results/momentum_multisteplr_loss_acc_avg_0.05.csv',
        index=False)
    pd_train_loss.to_csv(
        'results/momentum_multisteplr_train_loss_0.05.csv',
        index=False)
